export const LOAD = '@@quran/bookmarks/LOAD';
export const LOAD_SUCCESS = '@@quran/bookmarks/LOAD_SUCCESS';
export const LOAD_FAILURE = '@@quran/bookmarks/LOAD_FAILURE';
export const ADD_BOOKMARK = '@@quran/bookmarks/ADD_BOOKMARK';
